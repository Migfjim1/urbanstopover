...
counties_df <- read.csv("/Users/mikkojimenez/Library/Mobile Documents/com~apple~CloudDocs/Desktop/csu/phd/projects/urban stopover/urbanstopover_git/urbanstopover/urbanstopover_git/data/counties_df.csv")
